...
const TwentyFourDrawersTemplate = ({
  isGhost = false,
  placement,
  ...
  const gltf = useGLTF("/models/dragonfire-tools/24D.glb");
  ...
  return (
    <>
      ...
      >
        ...
        {!isPartOfPackage && placement?.cabinetId === 4 && (
          <CabinetFeet
...
export default TwentyFourDrawersTemplate;
