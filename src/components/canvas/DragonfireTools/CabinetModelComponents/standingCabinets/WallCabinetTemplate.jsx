...
const WallCabinetTemplate = ({ isGhost = false, placement }) => {
  ...
  const gltf = useGLTF("/models/dragonfire-tools/wall_cabinet.glb");
  ...
  return (
    <>
      <group
        position={[0, 0, boundingBox.depth / 2]}
...
export default WallCabinetTemplate;
