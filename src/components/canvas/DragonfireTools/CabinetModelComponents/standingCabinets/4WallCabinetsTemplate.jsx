...
const FourWallCabinetsTemplate = ({ isGhost = false, placement }) => {
  ...
  const boundingBox = {
    width: singleCabinetWidth * 4,
    height: 0.65,
    depth: 0.35,
  };

  const positions = [
    -singleCabinetWidth * 1.5,
    -singleCabinetWidth * 0.5,
    singleCabinetWidth * 0.5,
    singleCabinetWidth * 1.5,
  ];
...
export default FourWallCabinetsTemplate;
