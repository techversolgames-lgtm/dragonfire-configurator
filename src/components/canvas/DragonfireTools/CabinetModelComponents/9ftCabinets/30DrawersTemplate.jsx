...
const ThirtyDrawersTemplate = ({
  ...
  const gltf = useGLTF("/models/dragonfire-tools/30D.glb");
  ...
  const wbackPosition = [0, 0, -boundingBox.depth / 2 + 0.0125];
  ...
  return (
    <>
      ...
      >
        ...
        {!isPartOfPackage && placement?.cabinetId === 7 && (
          <CabinetFeet
...
export default ThirtyDrawersTemplate;
