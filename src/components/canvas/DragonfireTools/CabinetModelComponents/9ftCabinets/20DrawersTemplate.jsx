...
const TwentyDrawersTemplate = ({
  ...
  const gltf = useGLTF("/models/dragonfire-tools/20D_fix.glb");
  ...
  const wbackPosition = [0, 0, -boundingBox.depth / 2 + 0.001];
  ...
  return (
    <>
      ...
      >
        ...
        {!isPartOfPackage && placement?.cabinetId === 6 && (
          <CabinetFeet
...
export default TwentyDrawersTemplate;
